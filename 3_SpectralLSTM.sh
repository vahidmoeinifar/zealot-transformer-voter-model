...
#SBATCH --output=3-output-uni.txt
#SBATCH --error=3-error-uni.txt
...
sys.argv = [
    ...
    '--save_name',    'universal_lstm.pt',
]
runpy.run_path('${WORK_DIR}/3-lstm.py', run_name='__main__')
PYEOF
