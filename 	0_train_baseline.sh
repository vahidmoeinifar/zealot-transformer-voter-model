...
#SBATCH --job-name=baseline-model
...
#SBATCH --output=0-output-base.txt
#SBATCH --error=0-error-base.txt
...
sys.argv = [
    ...
    '--save_name',    'baseline.pt',
]
runpy.run_path('${WORK_DIR}/0-train-baseline.py', run_name='__main__')
PYEOF
